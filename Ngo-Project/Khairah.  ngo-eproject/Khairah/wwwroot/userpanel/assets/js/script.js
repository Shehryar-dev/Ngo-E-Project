...
/*==========================================================================
  ...
  /*------------------------------------------
    ...
    var user_eddress = document.getElementById("address");
    var user_file = document.getElementById("file");
   /* var user_message = document.getElementById("messages");*/
    if ($("#contact-form").length) {
        $("#contact-form").validate({
            ...
            messages: {
                ...
                user_file: "Please attach CV to submit form."
